...
module s5378_mixed ( n3065gat, n3066gat, n3067gat, n3068gat, n3069gat,
  ...
  output n1391gat, n1516gat, n1564gat, n1565gat, n1567gat, n1593gat,
         ...
         n933gat_EXTRA;
  wire n3000gat, n3112gat, n3115gat, n3152gat, n448, n449, n450, n451, n452,
  ...
  NAND3_X2 U584 ( .A1(n1880gat), .A2(n1834gat), .A3(n1767gat), .ZN(
        n1603gat_EXTRA) );
  INV_X1 U585 ( .A(1'b0), .ZN(n3000gat) );
  INV_X1 U587 ( .A(1'b0), .ZN(n3152gat) );
  INV_X1 U589 ( .A(1'b0), .ZN(n3115gat) );
  INV_X1 U591 ( .A(1'b0), .ZN(n3112gat) );
